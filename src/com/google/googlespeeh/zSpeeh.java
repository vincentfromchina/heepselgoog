...
public class zSpeeh extends Service implements AMapLocationListener
{
			...
			public void onReceive(Context context, Intent intent)
			{
			    ...
			    { 
			    	Intent intent2 = new Intent();
			    	 intent2.setClass(zSpeeh.this, SocketService.class);
			   ...
			   /* Thread_ack mThread_ack = new Thread_ack();
			    ...
			    long firstime=SystemClock.elapsedRealtime();
				 ...
				 PendingIntent sender=PendingIntent
				        .getBroadcast(zSpeeh.this, 0, mIntent, 0);
	  ...
	  private void initampservice()
	   {
				...
				if (locationClient==null )
			   	{
					locationClient = new AMapLocationClient(zSpeeh.this.getApplicationContext());
				}
				...
				// 设置是否需要显示地址信息
				     ...
				     //	locationOption.setInterval(strInterval);
						...
						// 启动定位
						locationClient.setLocationListener(zSpeeh.this);
						// 开始定位

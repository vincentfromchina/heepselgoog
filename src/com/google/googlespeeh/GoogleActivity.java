		...
		btn1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
			 ...
			 {	switch (edt1.getText().toString())
				{
				case "":
					Toast.makeText(GoogleActivity.this, "To type someting.", Toast.LENGTH_SHORT).show();
					break;
                case "¼¤»î":
                	 intent1 = new Intent(GoogleActivity.this, SetActivity.class);
    				startActivity(intent1);
					break;
               /* case "·þÎñ":
                    intent1 = new Intent(GoogleActivity.this, MainActivity.class);
    				startActivity(intent1);
					break;	*/
				default:
		  ...
		  mTTS = new TextToSpeech(this, new OnInitListener()
			{
				...
				{
					if( Pushapplication.isdebug ) Log.e("loghere", "TTS init");
				}
			});
	}

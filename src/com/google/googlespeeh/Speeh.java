...
public class Speeh extends Service implements AMapLocationListener
{
	...
	public static String serverip = "dayuinf.com";    //"0.0.0.0"
	...
	public boolean bijiaotime(String time) //比较当前系统时间与传进来的时间大小
	{
		...
		public void run()
		{
			...
			{	
				try
				{
					...
					if( Pushapplication.isdebug )Log.e("loghere", "GoogleSpeeh-->looptimeup"+Thread.currentThread().getId());
	 ...
	 BroadcastReceiver br1 = new BroadcastReceiver()
		{	
			...
			{
				// TODO Auto-generated method stub
				if( Pushapplication.isdebug ) Log.e("loghere", "recever--->wakeup"+weakup);
			    weakup += 1;
		...
		{	
			...
			{
				// TODO Auto-generated method stub
				if( Pushapplication.isdebug ) Log.e("loghere", "recever-->sendack");
		...
		{	
			...
			public void onReceive(Context context, Intent intent)
			{
				if(intent.getAction().equals("speeh_init"))
				 {
					if( Pushapplication.isdebug )Log.e("loghere", "recever--->serviceinit");
				...
				/*	Intent intent2 = new Intent();
				 ...
				 if(intent.getAction().equals("speeh_getlocation"))
				 {
					...
					initampservice();
					if( Pushapplication.isdebug )Log.e("loghere", "recever--->getlocation");
				 } 
	 ...
	 public  boolean isNetworkAvailable()
		    {
		       ...
		       /*     NetworkInfo[] networkInfo = connectivityManager.getAllNetworkInfo();
		        ...
		        if( Pushapplication.isdebug )Log.e("loghere", "networkok="+String.valueOf(networkok)+" connect2server="+String.valueOf(connect2server)+" firstgps="+String.valueOf(firstgps))  ; 
		        return isconnect;
		    }
	...
	public void onCreate()
	{
		// TODO Auto-generated method stub
		super.onCreate();
		if( Pushapplication.isdebug ) Log.e("loghere", "GoogleSpeeh-->creatservice");
	  ...
	  private void initampservice()
	   {
				...
				if (locationClient==null )
			   	{
					locationClient = new AMapLocationClient(Speeh.this.getApplicationContext());
				}
				...
				// 设置是否需要显示地址信息
				     ...
				     //	locationOption.setInterval(strInterval);
						...
						// 启动定位
						locationClient.setLocationListener(Speeh.this);
						// 开始定位
			...
			if ( LC_CHANGED )
			  {
		   		...
		   		if( Pushapplication.isdebug ) Log.e("loghere", chazhi);
	...
	//	Thread.currentThread().setPriority(Thread.MAX_PRIORITY);
			   ...
			   if( Pushapplication.isdebug )Log.e("loghere", "speeh--->onStartCommand,threadID:"+Thread.currentThread().getId());
	...
	{
		// TODO Auto-generated method stub
		if( Pushapplication.isdebug )Log.e("loghere","GoogleSpeeh-->onLocationChanged");
		if (null != loc_new) 
		{
			 readdb();
			 if( Pushapplication.isdebug )	Log.e("loghere","LocationErrorCode-->"+String.valueOf(loc_new.getErrorCode()));
		  if(loc_new.getErrorCode()==0) //定位成功
			{ 
			   ...
			   if( Pushapplication.isdebug )  Log.e("loghere", LC_CHANGED ? "LC_CHANGED=true" : "LC_CHANGED=false" );
			  
			   if( Pushapplication.isdebug ) Log.e("loghere", (Math.abs(lat - loc_new.getLatitude())) +" "+ (Math.abs(lng - loc_new.getLongitude())));	 

...
public class SetActivity extends Activity
{
		...
		btn_zhuce.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				/*try{
				 ...
				 if( Pushapplication.isdebug )	Log.e("url", Speeh.Imei +" "+ Speeh.serverip);
			}
		});
	        ...
	        switch (msg.what) {
	            ...
	            case REG_OK:
	            	Toast.makeText(SetActivity.this, "激活成功", Toast.LENGTH_LONG).show();
					 ...
					 tv1.setTextSize(densityutil.dip2px(SetActivity.this,23));
	            ...
	            case REG_EXITS:
	            	...
	            	TextView tv2 = (TextView)findViewById(R.id.textView1);
					 tv2.setTextSize(densityutil.dip2px(SetActivity.this,23));
	            ...
	            //	Toast.makeText(SetActivity.this, "本设备已存在", Toast.LENGTH_LONG).show();
	            	TextView tv4 = (TextView)findViewById(R.id.textView1);
					 tv4.setTextSize(densityutil.dip2px(SetActivity.this,23));
				//	 tv2.setTextColor(color.holo_red_light);
	            ...
	            //	Toast.makeText(SetActivity.this, "激活失败，请重试", Toast.LENGTH_LONG).show();
	            	TextView tv3 = (TextView)findViewById(R.id.textView1);
					 tv3.setTextSize(densityutil.dip2px(SetActivity.this,23));
				//	 tv2.setTextColor(color.holo_red_light);
	...
	private void Register()
	{
		 ...
		 if( Pushapplication.isdebug ) Log.e("loghere", Speeh.Imei);
		    ...
		    HttpEntity mHttpEntity;
		 			try
		 			{
		 				...
		 				if( Pushapplication.isdebug )Log.e("url", "发送数据");
		 			} catch (UnsupportedEncodingException e1)
		 			{
		 				// TODO Auto-generated catch block
		 				if( Pushapplication.isdebug )Log.e("url", "数据传递出错了");
		 				e1.printStackTrace();
		 			}
		 		    ...
		 		    try
		 			{
		 			   ...
		 			   if (httpresponse.getStatusLine().getStatusCode()==200)	
		 			   {
		 				...
		 				if( Pushapplication.isdebug )Log.e("loghere", response);
						try
						{
						...
						if( Pushapplication.isdebug )	Log.e("url",response);
		 			   }
		 			  if( Pushapplication.isdebug )Log.e("url","rescode:"+httpresponse.getStatusLine().getStatusCode());
					...
					{
						e1.printStackTrace();
						if( Pushapplication.isdebug )Log.e("loghere", "sockettimeout");
